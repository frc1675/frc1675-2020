...
public final class Constants {
    ...
    public static final int A_BUTTON = 1; //0
    public static final int B_BUTTON = 2; //1
    public static final int X_BUTTON = 3; //2
    public static final int Y_BUTTON = 4; //3

    public static final int LEFT_BUMPER = 5; //4
    public static final int RIGHT_BUMPER = 6; //5

    public static final int BACK_BUTTON = 7; //6
    public static final int START_BUTTON = 8; //7
