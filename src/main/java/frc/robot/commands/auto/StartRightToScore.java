...
public class StartRightToScore extends SequentialCommandGroup {
  ...
  private static final double SEGMENT_1 = 101.9; // 93.9

  private static final double TURN_2_ANGLE = 41.0; // 46.0

  private static final double SEGMENT_2 = 25.8; // 37.8
  /**
   * Creates a new ScoreFromRight.
   */
  public StartRightToScore(PIDDriveBase drive) {
