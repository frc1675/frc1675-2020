...
public class StartMiddleToTrench extends ParallelCommandGroup {

  private static final double TURN_1_ANGLE = -52;

  private static final double SEGMENT_1 = 84.4;
   ...
   */
  public StartMiddleToTrench(Drive2019 drive) {
